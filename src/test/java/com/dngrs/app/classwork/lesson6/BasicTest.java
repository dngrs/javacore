...
// in practice difference between sorting methods is time, but we will use earthier solution
    ...
    @Test
    public void aFirstTest() { //because tests in alphabetical order we use 'a', 'b' to order tests System.out.println("Simple sorting test");
...
// so after steps used to clean things, that will not be clean automatically expectedResults = null;
    }
